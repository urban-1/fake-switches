...
class Dell10GConfigureInterfaceSshTest(ProtocolTest):
    ...
    def test_description(self, t):
        enable(t)
        configuring_interface(
            t, "tengigabitethernet 0/0/1", do='description "hello WORLD"'
        )
        assert_interface_configuration(
            t, "tengigabitethernet 0/0/1", ['description "hello WORLD"']
        )

        configuring_interface(
            t, "tengigabitethernet 0/0/1", do="description 'We dont know yet'"
        )
        assert_interface_configuration(
            t, "tengigabitethernet 0/0/1", ['description "We dont know yet"']
        )

        configuring_interface(t, "tengigabitethernet 0/0/1", do="description YEEEAH")
        assert_interface_configuration(
            t, "tengigabitethernet 0/0/1", ['description "YEEEAH"']
        )
    ...
    def test_lldp_options_defaults_to_enabled(self, t):
        ...
        configuring_interface(
            t, "tengigabitethernet 0/0/1", do="no lldp med transmit-tlv capabilities"
        )
        configuring_interface(
            t, "tengigabitethernet 0/0/1", do="no lldp med transmit-tlv network-policy"
        )
        ...
        configuring_interface(
            t, "tengigabitethernet 0/0/1", do="lldp med transmit-tlv capabilities"
        )
        configuring_interface(
            t, "tengigabitethernet 0/0/1", do="lldp med transmit-tlv network-policy"
        )
    ...
    def test_spanning_tree(self, t):
        ...
        configuring_interface(
            t, "tengigabitethernet 0/0/1", do="spanning-tree portfast"
        )
        ...
        configuring_interface(
            t, "tengigabitethernet 0/0/1", do="no spanning-tree disable"
        )
        configuring_interface(
            t, "tengigabitethernet 0/0/1", do="no spanning-tree portfast"
        )
    ...
    def test_switchport_mode(self, t):
        ...
        configuring_interface(
            t, "tengigabitethernet 0/0/1", do="switchport mode access"
        )
        assert_interface_configuration(t, "tengigabitethernet 0/0/1", [""])

        configuring_interface(
            t, "tengigabitethernet 0/0/1", do="switchport access vlan 1264"
        )
        assert_interface_configuration(
            t, "tengigabitethernet 0/0/1", ["switchport access vlan 1264"]
        )
        ...
        configuring_interface(
            t, "tengigabitethernet 0/0/1", do="switchport mode general"
        )
        assert_interface_configuration(
            t,
            "tengigabitethernet 0/0/1",
        ...
        configuring_interface(
            t, "tengigabitethernet 0/0/1", do="switchport general pvid 1264"
        )
        assert_interface_configuration(
            t,
            "tengigabitethernet 0/0/1",
        ...
        configuring_interface(
            t, "tengigabitethernet 0/0/1", do="no switchport access vlan"
        )
        configuring_interface(
            t, "tengigabitethernet 0/0/1", do="switchport general allowed vlan add 1265"
        )
        assert_interface_configuration(
            t,
            "tengigabitethernet 0/0/1",
        ...
        configuring_interface(
            t, "tengigabitethernet 0/0/1", do="no switchport general pvid"
        )
        configuring_interface(
            t, "tengigabitethernet 0/0/1", do="no switchport general allowed vlan"
        )
        configuring_interface(t, "tengigabitethernet 0/0/1", do="switchport mode trunk")
        assert_interface_configuration(
            t, "tengigabitethernet 0/0/1", ["switchport mode trunk"]
        )
    ...
    def test_switchport_add_trunk_trunk_vlans_special_cases(self, t):
        ...
        configuring_interface(
            t, "tengigabitethernet 0/0/1", do="switchport trunk allowed vlan add 1200"
        )
        assert_interface_configuration(
            t,
            "tengigabitethernet 0/0/1",
        ...
        configuring_interface(
            t, "tengigabitethernet 0/0/1", do="switchport trunk allowed vlan 1200"
        )
        assert_interface_configuration(
            t,
            "tengigabitethernet 0/0/1",
        ...
        configuring_interface(
            t, "tengigabitethernet 0/0/1", do="switchport trunk allowed vlan add 1201"
        )
        assert_interface_configuration(
            t,
            "tengigabitethernet 0/0/1",
        ...
        configuring_interface(
            t, "tengigabitethernet 0/0/1", do="switchport trunk allowed vlan add 1202"
        )
        configuring_interface(
            t,
            "tengigabitethernet 0/0/1",
        ...
        configuring_interface(
            t, "tengigabitethernet 0/0/1", do="no switchport trunk allowed vlan"
        )
        assert_interface_configuration(
            t,
            "tengigabitethernet 0/0/1",
    ...
    def test_switchport_add_remove_trunk_trunk_vlans(self, t):
        ...
        configuring_interface(
            t,
            "tengigabitethernet 0/0/1",
            do="switchport trunk allowed vlan add 1200,1201",
        )
        assert_interface_configuration(
            t,
            "tengigabitethernet 0/0/1",
        ...
        configuring_interface(
            t,
            "tengigabitethernet 0/0/1",
            do="switchport trunk allowed vlan add 1201-1203,1205",
        )
        assert_interface_configuration(
            t,
            "tengigabitethernet 0/0/1",
        ...
        configuring_interface(
            t,
            "tengigabitethernet 0/0/1",
            do="switchport trunk allowed vlan remove 1202",
        )
        assert_interface_configuration(
            t,
            "tengigabitethernet 0/0/1",
        ...
        configuring_interface(
            t,
            "tengigabitethernet 0/0/1",
            do="switchport trunk allowed vlan remove 1203,1205",
        )
        assert_interface_configuration(
            t,
            "tengigabitethernet 0/0/1",
        ...
        configuring_interface(
            t,
            "tengigabitethernet 0/0/1",
            do="switchport trunk allowed vlan remove 1200-1203",
        )
        assert_interface_configuration(
            t,
            "tengigabitethernet 0/0/1",
    ...
    def test_switchport_add_remove_general_trunk_vlans(self, t):
        ...
        configuring_interface(
            t, "tengigabitethernet 0/0/1", do="switchport general allowed vlan add 1200"
        )
        assert_interface_configuration(
            t,
            "tengigabitethernet 0/0/1",
    ...
    def test_show_interfaces_status(self, t):
        ...
        configuring_interface(
            t,
            "tengigabitethernet 0/0/1",
            do='description "longer name than whats allowed"',
        )
        create_bond(t, 43)
        ...
        t.readln(
            "Te0/0/2                                   Full   10000   Auto Up     Active"
        )
        t.readln(
