...
class JuniperBaseProtocolTest(BaseJuniper):
    ...
    def test_bad_configuration_element(self):
        with self.assertRaises(RPCError):
            self.nc.edit_config(
                target="candidate",
                config=dict_2_etree(
                    {"config": {"configuration": {"vbleh": "shizzle"}}}
                ),
            )
    ...
    def test_create_vlan(self):
        ...
        result = self.nc.get_config(
            source="running",
            filter=dict_2_etree({"filter": {"configuration": {"vlans": {}}}}),
        )
    ...
    def test_vlan_configuration_merging(self):
        self.edit({"vlans": {"vlan": [{"name": "VLAN2999"}, {"vlan-id": "2995"}]}})
        self.edit(
            {"vlans": {"vlan": [{"name": "VLAN2999"}, {"description": "shizzle"}]}}
        )
        self.nc.commit()
    ...
    def test_access_mode(self):
        self.edit(
            {
                "vlans": {"vlan": [{"name": "VLAN2995"}, {"vlan-id": "2995"}]},
                "interfaces": {
                    "interface": [
                        {"name": "ge-0/0/3"},
                        {
            ...
            filter=dict_2_etree(
                {
                    "filter": {
                        "configuration": {
                            "interfaces": {"interface": {"name": "ge-0/0/3"}}
                        }
                    }
                }
            ),
        ...
        assert_that(
            result.xpath("data/configuration/interfaces/interface"), has_length(1)
        )
        ...
        assert_that(
            int003.xpath("unit/family/ethernet-switching/port-mode")[0].text,
            equal_to("access"),
        )
        assert_that(
            int003.xpath("unit/family/ethernet-switching/vlan/members"), has_length(1)
        )
        assert_that(
            int003.xpath("unit/family/ethernet-switching/vlan/members")[0].text,
            equal_to("2995"),
        )
                    ...
                    "interface": [
                        {"name": "ge-0/0/3"},
                        {
                            "unit": [
                                ...
                                {
                                    "family": {
                                        "ethernet-switching": {"native-vlan-id": "2000"}
                                    }
                                },
                            ]
                        },
    ...
    def test_trunk_mode_allows_no_vlan_members(self):
        self.edit(
            {
                "vlans": [
                    {"vlan": [{"name": "VLAN2995"}, {"vlan-id": "2995"}]},
                    {"vlan": [{"name": "VLAN2996"}, {"vlan-id": "2996"}]},
                    {"vlan": [{"name": "VLAN2997"}, {"vlan-id": "2997"}]},
                ],
                "interfaces": {
                    "interface": [
                        {"name": "ge-0/0/3"},
    ...
    def test_trunk_mode(self):
        ...
        assert_that(
            int003.xpath("unit/family/ethernet-switching/native-vlan-id")[0].text,
            equal_to("2996"),
        )
        assert_that(
            int003.xpath("unit/family/ethernet-switching/vlan/members"), has_length(2)
        )
        assert_that(
            int003.xpath("unit/family/ethernet-switching/vlan/members")[0].text,
            equal_to("2995"),
        ...
        assert_that(
            int003.xpath("unit/family/ethernet-switching/vlan/members")[1].text,
            equal_to("2997"),
        )
                    ...
                    "interface": [
                        {"name": "ge-0/0/3"},
                        {
                            "unit": [
                                ...
                                {
                                    "family": {
                                        "ethernet-switching": {"native-vlan-id": "2995"}
                                    }
                                },
                            ]
                        },
    ...
    def test_passing_from_trunk_mode_to_access_gets_rid_of_stuff_in_trunk_mode(self):
        ...
        self.edit(
            {
                "vlans": [
                    {"vlan": [{"name": "VLAN1100"}, {"vlan-id": "1100"}]},
                    {"vlan": [{"name": "VLAN1200"}, {"vlan-id": "1200"}]},
                    {"vlan": [{"name": "VLAN1300"}, {"vlan-id": "1300"}]},
                    {"vlan": [{"name": "VLAN1400"}, {"vlan-id": "1400"}]},
                ]
            }
        )
        self.nc.commit()
                    ...
                    "interface": [
                        {"name": "ge-0/0/3"},
                        {
                            "unit": [
                                ...
                                {
                                    "family": {
                                        "ethernet-switching": {"native-vlan-id": "1200"}
                                    }
                                },
                            ]
                        },
        ...
        assert_that(
            int003.xpath("unit/family/ethernet-switching/vlan/members"), has_length(3)
        )
        ...
        assert_that(
            int003.xpath("unit/family/ethernet-switching/native-vlan-id"), has_length(0)
        )
        assert_that(
            int003.xpath("unit/family/ethernet-switching/vlan/members"), has_length(0)
        )
    ...
    def test_display_interface_with_description_and_trunk_native_vlan(self):
        ...
        assert_that(int003.xpath("name")[0].text, equal_to("ge-0/0/3"))
        assert_that(
            int003.xpath("description")[0].text, equal_to("I see what you did there!")
        )

        assert_that(
            int003.xpath("unit/family/ethernet-switching/vlan/members")
        ), has_length(2)
    ...
    def test_display_interface_trunk_native_vlan_and_no_vlan_members_or_trunk_mode(
        self,
    ):
        self.edit(
            {
                "vlans": [{"vlan": [{"name": "VLAN2996"}, {"vlan-id": "2996"}]}],
                "interfaces": {
                    "interface": [
                        {"name": "ge-0/0/3"},
                        {
                            "unit": [
                                ...
                                {
                                    "family": {
                                        "ethernet-switching": {"native-vlan-id": "2996"}
                                    }
                                },
                            ]
                        },
    ...
    def test_set_spanning_tree_options(self):
        self.edit(
            {
                ...
                "interfaces": [_access_interface("ge-0/0/3")],
            }
        )
            ...
            filter=dict_2_etree(
                {
                    "filter": {
                        "configuration": {
                            "protocols": {"rstp": {"interface": {"name": "ge-0/0/3.0"}}}
                        }
                    }
                }
            ),
        ...
        assert_that(
            result.xpath("data/configuration/protocols/rstp/interface"), has_length(1)
        )
        ...
        result = self.nc.get_config(
            source="running",
            filter=dict_2_etree({"filter": {"configuration": {"protocols": ""}}}),
        )
    ...
    def test_deleting_spanning_tree_options(self):
        ...
        assert_that(
            result.xpath("data/configuration/protocols/rstp/interface"), has_length(0)
        )
    ...
    def test_set_lldp(self):
        self.edit(
            {
                "protocols": {
                    "lldp": {"interface": [{"name": "ge-0/0/3"}, {"disable": ""}]}
                }
            }
        )
            ...
            filter=dict_2_etree(
                {
                    "filter": {
                        "configuration": {
                            "protocols": {"lldp": {"interface": {"name": "ge-0/0/3.0"}}}
                        }
                    }
                }
            ),
        ...
        assert_that(
            result.xpath("data/configuration/protocols/lldp/interface"), has_length(1)
        )
        ...
        assert_that(
            result.xpath("data/configuration/protocols/lldp/interface")[0],
            has_length(1),
        )
    ...
    def test_lldp_on_unconfigured_bond_works(self):
        self.edit(
            {"protocols": {"lldp": {"interface": [{"name": "ae3"}, {"disable": ""}]}}}
        )
        self.nc.commit()
    ...
    def test_set_interface_description(self):
        ...
        assert_that(
            int002.xpath("description")[0].text, equal_to("Hey there beautiful")
        )
        ...
        assert_that(
            result.xpath("data/configuration/interfaces/interface"), has_length(0)
        )
    ...
    def test_set_interface_raises_on_physical_interface_with_bad_trailing_input(self):
        ...
        assert_that(
            str(exc.exception),
            contains_string("invalid trailing input 'foobar' in 'ge-0/0/43foobar'"),
        )
    ...
    def test_set_interface_raises_for_physical_interface_for_out_of_range_port(self):
        ...
        assert_that(
            str(exc.exception),
            contains_string(
                "port value outside range 1..127 for '128' in 'ge-0/0/128'"
            ),
        )
    ...
    def test_set_interface_raises_on_aggregated_invalid_interface_type(self):
        ...
        assert_that(
            str(exc.exception),
            contains_string("invalid interface type in 'ae34foobar345'"),
        )
    ...
    def test_set_interface_raises_on_aggregated_out_of_range_port(self):
            ...
            self.edit(
                {
                    "interfaces": {
                        "interface": [
                            {"name": "ae34345"},
                            {"aggregated-ether-options": {"link-speed": "10g"}},
                        ]
                    }
                }
            )
        assert_that(
            str(exc.exception),
            contains_string(
                "device value outside range 0..127 for '34345' in 'ae34345'"
            ),
        )

    def test_set_interface_disabling(self):
        self.edit(
            {"interfaces": {"interface": [{"name": "ge-0/0/2"}, {"disable": ""}]}}
        )
        self.nc.commit()
    ...
    def test_create_aggregated_port(self):
        ...
        assert_that(
            ae1.xpath("aggregated-ether-options/link-speed")[0].text, is_("10g")
        )
        ...
        assert_that(
            ae1.xpath("aggregated-ether-options/lacp/periodic")[0].text, is_("slow")
        )
        ...
        assert_that(
            ae1.xpath("unit/family/ethernet-switching/vlan/members"), has_length(2)
        )
    ...
    def test_posting_delete_on_both_auto_negotiation_flags_delete_and_raises(self):
        ...
        assert_that(
            ...
            contains_string("warning: statement not found: no-auto-negotiation"),
        )
        assert_that(
            str(expect.exception),
            contains_string("warning: statement not found: auto-negotiation"),
        )
        ...
        assert_that(
            str(expect.exception),
            is_not(contains_string("warning: statement not found: auto-negotiation")),
        )
    ...
    def test_assign_port_to_aggregated_interface(self):
        ...
        self.edit(
            {
                ...
                "interfaces": [
                    ...
                    {
                        "interface": [
                            {XML_ATTRIBUTES: {"operation": "replace"}},
                            {"name": "ge-0/0/2"},
                            {
                                "ether-options": {
                                    "speed": {"ethernet-10g": {}},
        ...
        assert_that(
            ge001.xpath("ether-options/ieee-802.3ad/bundle")[0].text, is_("ae1")
        )
        ...
        assert_that(
            ge002.xpath("ether-options/ieee-802.3ad/bundle")[0].text, is_("ae1")
        )
    ...
    def test_discard_trunk_members_really_works(self):
        ...
        before = self.nc.get_config(
            source="running",
            filter=dict_2_etree(
                {"filter": {"configuration": [{"interfaces": {}}, {"vlans": {}}]}}
            ),
        )
        ...
        assert_that(
            to_xml(before.xpath("data/configuration/vlans")[0]),
            xml_equals_to(after.xpath("data/configuration/vlans")[0]),
        )
        assert_that(
            to_xml(before.xpath("data/configuration/interfaces")[0]),
            xml_equals_to(after.xpath("data/configuration/interfaces")[0]),
        )
    ...
    def test_replace_port_with_nothing_leaves_configuration_empty(self):
        ...
        get_interface_reply = self.nc.get_config(
            source="running",
            filter=dict_2_etree(
                {
                    "filter": {
        ...
        self.edit(
            {"interfaces": [{"interface": [{"name": "ge-0/0/1"}, {"disable": ""}]}]}
        )
    ...
    def test_operational_request_unknown_fails(self):
        with self.assertRaises(RPCError):
            self.nc.rpc(dict_2_etree({"waaaat": {}}))

        with self.assertRaises(RPCError):
            self.nc.rpc(
                dict_2_etree({"get-interface-information": {"wrong-param": {}}})
            )
    ...
    def test_operational_request_get_interface_information_terse(self):
        self.edit(
            {
                "interfaces": [
                    ...
                    },
                    {
                        "interface": [
                            {"name": "ge-0/0/3"},
                            {"ether-options": {"ieee-802.3ad": {"bundle": "ae1"}}},
                            {"unit": {XML_ATTRIBUTES: {"operation": "delete"}}},
                        ]
                    },
                    {"interface": [{"name": "ge-0/0/4"}, {"disable": ""}]},
                    {
                        "interface": [
                            {"name": "ae3"},
                            {
        ...
        terse = self.nc.rpc(dict_2_etree({"get-interface-information": {"terse": {}}}))

        assert_that(
            terse.xpath("interface-information/physical-interface"), has_length(8)
        )  # 4 physical 4 bonds

        deleted_interface = terse.xpath(
            "interface-information/physical-interface/name[contains(text(),'\nge-0/0/1\n')]/.."
        )[0]
        ...
        access_mode_interface = terse.xpath(
            "interface-information/physical-interface/name[contains(text(),'\nge-0/0/2\n')]/.."
        )[0]
        ...
        assert_that(
            access_mode_interface.xpath("logical-interface/name")[0].text,
            is_("\nge-0/0/2.0\n"),
        )
        assert_that(
            access_mode_interface.xpath("logical-interface/admin-status")[0].text,
            is_("\nup\n"),
        )
        assert_that(
            access_mode_interface.xpath("logical-interface/oper-status")[0].text,
            is_("\ndown\n"),
        )
        assert_that(
            access_mode_interface.xpath("logical-interface/filter-information"),
            has_length(1),
        )
        assert_that(
            access_mode_interface.xpath("logical-interface/filter-information/*"),
        ...
        assert_that(
            access_mode_interface.xpath("logical-interface/address-family/*"),
            has_length(1),
        )
        assert_that(
            access_mode_interface.xpath(
                "logical-interface/address-family/address-family-name"
            )[0].text,
            is_("\neth-switch\n"),
        )

        bond_member_interface = terse.xpath(
            "interface-information/physical-interface/name[contains(text(),'\nge-0/0/3\n')]/.."
        )[0]
        ...
        assert_that(
            active_bond.xpath("logical-interface/name")[0].text, is_("\nae3.0\n")
        )
        assert_that(
            active_bond.xpath("logical-interface/admin-status")[0].text, is_("\nup\n")
        )
        assert_that(
            active_bond.xpath("logical-interface/oper-status")[0].text, is_("\ndown\n")
        )
        assert_that(
            active_bond.xpath("logical-interface/filter-information"), has_length(1)
        )
        assert_that(
            active_bond.xpath("logical-interface/filter-information/*"), has_length(0)
        )
        assert_that(
            active_bond.xpath("logical-interface/address-family/*"), has_length(1)
        )
        assert_that(
            active_bond.xpath("logical-interface/address-family/address-family-name")[
                0
            ].text,
            is_("\neth-switch\n"),
        )
    ...
    def test_set_interface_mtu(self):
        self.edit(
            {
                "interfaces": [
                    {"interface": [{"name": "ge-0/0/2"}, {"mtu": "1000"}]},
                    {"interface": [{"name": "ae2"}, {"mtu": "1500"}]},
                ]
            }
        )
    ...
    def test_set_interface_mtu_error_messages(self):
        with self.assertRaises(RPCError) as exc:
            self.edit(
                {"interfaces": {"interface": [{"name": "ge-0/0/2"}, {"mtu": "wat"}]}}
            )

        assert_that(str(exc.exception), contains_string("Invalid numeric value: 'wat'"))

        with self.assertRaises(RPCError) as exc:
            self.edit({"interfaces": {"interface": [{"name": "ae2"}, {"mtu": "0"}]}})

        assert_that(
            str(exc.exception),
            contains_string("Value 0 is not within range (256..9216)"),
        )

    def test_that_an_aggregated_interface_cannot_be_deleted_while_there_is_still_an_rstp_configuration(
        self,
    ):
        self.edit(
            {
                ...
                "interfaces": [_access_interface("ae3")],
            }
        )
    ...
    def test_that_an_interface_cannot_be_deleted_while_there_is_still_an_rstp_configuration(
        self,
    ):
        self.edit(
            {
